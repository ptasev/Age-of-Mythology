        ...
        public static BrgFileTestObject CreateAIMarkerTest(BrgFile brg)
        {
            ...
            static List<BrgMeshTestObject> CreateMeshTests(BrgFile brg)
            {
                var test0 = new BrgMeshTestObject(brg.Meshes[0])
                {
                    ...
                    Flags = BrgMeshFlag.Texture1 | BrgMeshFlag.Material,
                    VertCount = 79,
                    NormalsCount = 79,
                    TexCoordsCount = 79,
                    FaceCount = 40,
        ...
        public static BrgFileTestObject CreateArcherThrowingAxemanTest(BrgFile brg)
        {
            ...
            static List<BrgMeshTestObject> CreateMeshTests(BrgFile brg)
            {
                var test0 = new BrgMeshTestObject(brg.Meshes[0])
                {
                    ...
                    Flags = BrgMeshFlag.Texture1 | BrgMeshFlag.Material | BrgMeshFlag.DummyObjects,
                    VertCount = 129,
                    NormalsCount = 129,
                    TexCoordsCount = 129,
                    FaceCount = 126,
                ...
                var test1 = new BrgMeshTestObject(brg.Meshes[1])
                {
                    ...
                    InterpType = BrgMeshInterpolationType.Default,
                    AnimType = BrgMeshAnimType.KeyFrame,
                    Flags = BrgMeshFlag.Texture1 | BrgMeshFlag.Material | BrgMeshFlag.DummyObjects | BrgMeshFlag.Secondary,
                    VertCount = 129,
                    NormalsCount = 129,
                    TexCoordsCount = 0,
                    FaceCount = 0,
        ...
        public static BrgFileTestObject CreateScenDwarvenForgeTredTest(BrgFile brg)
        {
            ...
            static List<BrgMeshTestObject> CreateMeshTests(BrgFile brg)
            {
                var test0 = new BrgMeshTestObject(brg.Meshes[0])
                {
                    ...
                    InterpType = BrgMeshInterpolationType.Default,
                    AnimType = BrgMeshAnimType.KeyFrame,
                    Flags = BrgMeshFlag.Texture1 | BrgMeshFlag.Material | BrgMeshFlag.DummyObjects | BrgMeshFlag.AnimTxCoords,
                    VertCount = 16,
                    NormalsCount = 16,
                    TexCoordsCount = 16,
                    FaceCount = 10,
                ...
                var test1 = new BrgMeshTestObject(brg.Meshes[1])
                {
                    ...
                    InterpType = BrgMeshInterpolationType.Default,
                    AnimType = BrgMeshAnimType.KeyFrame,
                    Flags = BrgMeshFlag.Texture1 | BrgMeshFlag.Material | BrgMeshFlag.DummyObjects | BrgMeshFlag.Secondary | BrgMeshFlag.AnimTxCoords,
                    VertCount = 16,
                    NormalsCount = 16,
                    TexCoordsCount = 16,
                    FaceCount = 0,
