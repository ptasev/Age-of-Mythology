...
namespace AoMProtoEditor
{
    ...
    {
        IDictionary<TFirst, TSecond> firstToSecond;
        IDictionary<TSecond, TFirst> secondToFirst;
        ...
        public BiDictionaryOneToOne(int capacity, IEqualityComparer<TFirst> comparer)
        {
            firstToSecond = new Dictionary<TFirst, TSecond>(capacity, comparer);
            secondToFirst = new Dictionary<TSecond, TFirst>(capacity);
        }
        public BiDictionaryOneToOne(int capacity, IEqualityComparer<TFirst> comparer, IEqualityComparer<TSecond> comparerSecond)
        {
            firstToSecond = new Dictionary<TFirst, TSecond>(capacity, comparer);
            secondToFirst = new Dictionary<TSecond, TFirst>(capacity, comparerSecond);
        }
        public BiDictionaryOneToOne(IEqualityComparer<TFirst> comparer)
        {
        ...
        public TFirst GetBySecond(TSecond second)
        {
            ...
            if (!secondToFirst.TryGetValue(second, out first))
                throw new ArgumentException("second " + second);
