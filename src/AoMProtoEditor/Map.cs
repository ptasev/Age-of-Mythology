...
namespace AoMProtoEditor
{
    ...
    {
        private IDictionary<string, int> stringLookup;
        ...
        {
            stringLookup = new Dictionary<string, int>(capacity);
        }
        public StringTable(IEqualityComparer<string> comparer)
        {
            stringLookup = new Dictionary<string, int>(comparer);
        }
        public StringTable(int capacity, IEqualityComparer<string> comparer)
        {
            stringLookup = new Dictionary<string, int>(capacity, comparer);
        }
